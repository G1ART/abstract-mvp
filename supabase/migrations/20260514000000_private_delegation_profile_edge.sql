...
--
-- Pre-requisite:
--   This migration depends on `viewer_shares_follow_edge_with(uuid)`,
--   defined by `20260513000000_private_account_signup_hotfix.sql`. Apply
--   the hotfix first if you have not already.
