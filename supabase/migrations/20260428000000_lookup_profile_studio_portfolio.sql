-- Expose only studio_portfolio from profiles.profile_details on public username lookup
-- (safe slice for portfolio tab labels / custom tabs / visibility — no other details keys).
