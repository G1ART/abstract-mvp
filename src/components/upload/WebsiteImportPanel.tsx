        ...
        <div className="space-y-4 border-t border-zinc-100 px-4 pb-4 pt-3">
          ...
          {scanDone && candidates.length > 0 && (
            <div
              ...
              role="status"
            >
              {t("bulk.wi.matchLimitCallout").replace("{n}", String(UPLOAD_WEBSITE_MATCH_MAX_ARTWORKS))}
            </div>
          )}
          {scanDone && (
            <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
              <button
                ...
                className="inline-flex w-fit rounded-lg border border-zinc-300 bg-zinc-50 px-3 py-2 text-sm font-medium text-zinc-900 hover:bg-zinc-100 disabled:opacity-50"
              >
                {busy === "match"
